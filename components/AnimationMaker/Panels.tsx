  ...
  return (
    ...
    <div className="absolute top-4 left-4 z-30 lg:hidden">
       <button 
         ...
         className="bg-slate-900 border border-slate-700 p-2 rounded-lg text-slate-300 shadow-xl"
       >
         {isMobilePanelOpen ? (
    ...
    <div className={`
        absolute z-20 overflow-y-auto custom-scrollbar transition-all duration-300
        lg:left-4 lg:top-16 lg:bottom-16 lg:w-64 lg:rounded-none
        ${isMobilePanelOpen 
            ? 'left-0 bottom-0 w-full h-[60%] rounded-t-3xl border-t border-slate-700 bg-slate-900 shadow-2xl p-4' 
            : 'hidden lg:flex lg:flex-col lg:gap-2 pointer-events-none'
        }
    `}>
       
       <div className={`${isMobilePanelOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}>
           
       {store.activeTab === 'history' && (
           <div className="bg-slate-900/80 p-4 lg:rounded-2xl border border-slate-700 shadow-2xl backdrop-blur-md pointer-events-auto space-y-4 animate-fade-in flex flex-col max-h-[500px]">
       ...
       {store.activeTab === 'parameters' && (
           <div className="bg-slate-900/80 p-4 lg:rounded-2xl border border-slate-700 shadow-2xl backdrop-blur-md pointer-events-auto space-y-4 animate-fade-in">
       ...
       {store.activeTab === 'tools' && (
           <div className="bg-slate-900/80 p-3 lg:rounded-2xl border border-slate-700 shadow-2xl backdrop-blur-md pointer-events-auto animate-fade-in space-y-4">
              {/* GIZMOS */}
              <div>
       ...
       {store.activeTab === 'hierarchy' && (
           <div className="bg-slate-900/80 p-4 lg:rounded-2xl border border-slate-700 shadow-2xl backdrop-blur-md pointer-events-auto space-y-4 animate-fade-in flex flex-col max-h-[400px]">
